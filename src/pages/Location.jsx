  ...
  return (
    <div style={{ backgroundColor: '#050505', minHeight: '100vh', fontFamily: "'Segoe UI', sans-serif", color: '#fff' }}>
      ...
      <div style={{ maxWidth: '1000px', margin: '0 auto', padding: '1.5rem' }}>
        ...
        <div className="location-grid" style={{ display: 'grid', gap: '16px' }}>
          ...
          <div style={{ background: '#0a0a0a', border: '1px solid #151515', borderRadius: '14px', overflow: 'hidden' }}>
            <iframe
              ...
              width="100%" height="320" style={{ border: 'none', display: 'block' }} allowFullScreen="" loading="lazy"
            />
          </div>
          ...
          <div style={{ background: '#0a0a0a', border: '1px solid #151515', borderRadius: '14px', padding: '20px', display: 'flex', flexDirection: 'column', gap: '16px' }}>
            ...
            {[
              ...
              <div key={item.label} style={{ display: 'flex', gap: '12px', alignItems: 'flex-start' }}>
                <div style={{ width: '36px', height: '36px', borderRadius: '10px', background: '#0d2d0d', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '16px', flexShrink: 0 }}>{item.icon}</div>
                <div>
            ...
            <button onClick={() => window.open('https://maps.google.com/?q=3111+Sto.+Rosario+Aliaga+Nueva+Ecija+Philippines', '_blank')} style={{ background: '#22c55e', color: '#000', border: 'none', borderRadius: '10px', padding: '12px', fontSize: '13px', fontWeight: '700', cursor: 'pointer', textTransform: 'uppercase', letterSpacing: '0.05em' }}>
              Open in Google Maps
            </button>
            <button onClick={() => navigate('/messages')} style={{ background: 'transparent', color: '#22c55e', border: '1px solid #22c55e22', borderRadius: '10px', padding: '12px', fontSize: '13px', fontWeight: '700', cursor: 'pointer', textTransform: 'uppercase', letterSpacing: '0.05em' }}>
              💬 Message Us
            </button>
          </div>
        </div>
      ...
      <style>{`
        @media (min-width: 769px) {
          .location-grid { grid-template-columns: 1fr 320px !important; align-items: start; }
        }
